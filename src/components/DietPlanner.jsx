...
import { User, Activity, Target, Lightbulb } from 'lucide-react';
...
const DietPlanner = ({ onUpdateGoals, currentGoals }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      {/* Daily Tip Card */}
      <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 shadow-sm flex items-start">
        <div className="bg-yellow-400 p-2 rounded-lg text-white mr-4 mt-1">
          <Lightbulb size={24} />
        </div>
        <div>
          <h4 className="font-bold text-yellow-800">Günün Sağlık İpucu</h4>
          <p className="text-yellow-700 italic">"{tip}"</p>
        </div>
      </div>
